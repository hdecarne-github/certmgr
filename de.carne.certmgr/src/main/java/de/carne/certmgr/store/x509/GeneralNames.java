 ...
 */
public class GeneralNames extends ASN1EncodableSequence<GeneralName> {
	 ...
	 */
	public static GeneralNames asn1Decode(ASN1Decoder decoder) throws IOException {
		ASN1Decoder[] sequence = decoder.asn1DecodeSequence(-1, -1);
		GeneralNames names = new GeneralNames();

		for (ASN1Decoder sequenceEntry : sequence) {
			names.addElement(GeneralName.asn1Decode(sequenceEntry));
		}
		return names;
	}
