...
/**
 * Exception indicating that a password is required to access a resource.
 */
public class PasswordRequiredException extends StoreException {
	...
	/**
	 * Construct PasswordRequiredException.
	 *
