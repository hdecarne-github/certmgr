...
public class CertChooserDialog extends Dialog<UserCertStoreEntry> {
	...
	/**
	 * Load the choose certificate dialog.
	 *
	 ...
	 */
	public static CertChooserController load(StageController owner) throws IOException {
		return owner.loadDialog((c) -> new CertChooserDialog(c), CertChooserController.class);
	}
